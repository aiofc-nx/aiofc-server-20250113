 ...
 */
export declare const booleanAsString: () => z.ZodEffects<z.ZodOptional<z.ZodNullable<z.ZodUnion<[z.ZodEnum<["true", "false", ""]>, z.ZodBoolean]>>>, boolean, boolean | "" | "true" | "false">;
/**
 ...
 */
export declare const stringNumber: (defaultValue: number) => z.ZodDefault<z.ZodNumber>;
